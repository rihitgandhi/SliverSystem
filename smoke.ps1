...
$gets = '/','/index.html','/chat.html','/score.html','/alt-text-generator.html','/code-reviewer.html','/content-simplifier.html','/help.html','/Blog_1.html','/api/health','/css/main.css','/scripts/tool-shared.js','/scripts/chatbot.js'
foreach ($g in $gets) {
  try {
